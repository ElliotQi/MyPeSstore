...
import static org.csu.mypetstore.web.servlets.AddItemToCartServlet.totaprice;
...
public class OrderDAOlmpl implements OrderDAO {
    ...
    public List<Order> getOrdersByUsername(String username) {
        ...
        try {
            ...
            while(resultSet.next()){
                ...
                order.setTotalPrice(resultSet.getString(24));
    ...
    public boolean insertOrder(Order order) {
        ...
        try {
            ...
            preparedStatement.setString(17, totaprice);
